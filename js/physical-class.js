var questions = [
  ...
  {question:"Why do you need physical class?"},
...
;(function(){
  ...
  function done() {
    ...
    h1.appendChild(document.createTextNode('Thanks ' + questions[0].value + ' !'))
	h1.appendChild(document.createTextNode(' We will mail you our decision about this ' + ' !'))
    setTimeout(function() {
